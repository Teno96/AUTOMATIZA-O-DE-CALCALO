...
for x in range(i):
    ...
    if z != 0:
         ...
         'desse modo, não insere a informação'
         sheet_a['F16']=vao_a
         sheet_a['K16']=vao_b
         ...
         'um modo usando a biblioteca pyautogui, mas não deu certo, porém, inseriu as informações na planilha'
         ...
         'Tirar print da página do excel com todas as informações'
